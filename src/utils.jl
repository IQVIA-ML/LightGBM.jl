...
const BOOSTERPARAMS = [:application, :boosting, :learning_rate, :num_leaves, :max_depth, :tree_learner,
                       ...
                       :uniform_drop, :drop_seed, :top_rate, :other_rate, :metric, :is_training_metric, :ndcg_at, :num_machines,
